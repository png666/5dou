...
- (void)updateAllButtonsFrame {
    ...
    for (int i=0; i<self.actions.count; i++) {
        ...
        if (i <= self.actions.count - 2) {
            [btn addBorderWithColor:WDColorFrom16RGB(0x8b572a) size:0.5  borderTypes:@[@(BorderTypeTop),@(BorderTypeRight)]];
        }else {
            [btn addBorderWithColor:WDColorFrom16RGB(0x8b572a) size:0.5  borderTypes:@[@(BorderTypeTop)]];
        }

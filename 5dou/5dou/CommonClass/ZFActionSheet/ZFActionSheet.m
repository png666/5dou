...
- (void)createSubViews
{
    ...
    for (int i=0; i<self.confirms.count; i++) {
        ...
        confirm.titleLabel.font = [UIFont systemFontOfSize:ZFSize_15];
        [confirm setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        if (self.style == ZFActionSheetStyleDestructive) {
            [confirm setTitleColor:WDColorFrom16RGB(0x8d572a) forState:UIControlStateNormal];
        }else if(self.style == ZFActionSheetStyleCancel){
            
            confirm.titleLabel.font = [UIFont boldSystemFontOfSize:ZFSize_15];
        }
    ...
    [cancel setTitleColor:WDColorFrom16RGB(0x8d572a) forState:UIControlStateNormal];
    cancel.titleLabel.font = [UIFont systemFontOfSize:ZFSize_15];

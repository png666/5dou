...
- (void)setDateViewWithTitle:(NSString *)title
{
    ...
    [submit setTitleColor:kGrayColor forState:UIControlStateNormal];
    submit.backgroundColor = [UIColor whiteColor];
    submit.titleLabel.font = kFont18;
    ...
    // 1.日期Picker
    UIDatePicker *datePickr = [[UIDatePicker alloc] initWithFrame:CGRectMake(0, 40, SCREENSIZE.width, 180)];
    ...
    float height = 210;
    self.frame = CGRectMake(0, SCREENSIZE.height - height-64, SCREENSIZE.width, height);
}
